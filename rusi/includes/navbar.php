    ...
    <div class="container position-relative w-100">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
            <ul class="navbar-nav navbar-center d-flex align-items-center" style="gap: 0.5rem;">
                <li class="nav-item">
                    <a class="nav-link px-2" href="index.php" data-text="HOME"><span>HOME</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-2" href="products.php" data-text="PRODUCTS"><span>PRODUCTS</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-2" href="feedback.php" data-text="CONTACT US"><span>CONTACT US</span></a>
                </li>
            </ul>
        </div>
